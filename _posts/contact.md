...
Connect with our engineering and advisory team for speaking engagements, technical advisory, or enterprise collaboration.
...
<div class="card" style="margin-top: 2rem;">
  ...
  <form action="https://formspree.io/f/contact" method="POST" class="stack" style="gap: 1rem; margin-top: 1rem;">
    ...
    <div>
      ...
      <textarea id="message" name="message" rows="4" required placeholder="Describe your advisory or technical inquiry..." style="width: 100%; padding: 0.6rem; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-surface); color: var(--text-color);"></textarea>
    </div>
